...
extern crate lightgbm2;
extern crate serde_json;

use std::iter::zip;
use lightgbm2::{Booster, Dataset};
use serde_json::json;
...
fn main() -> std::io::Result<()> {
    let (train_features, train_labels) =
        load_file("../../lightgbm2-sys/lightgbm/examples/regression/regression.train");
    let (test_features, test_labels) =
        load_file("../../lightgbm2-sys/lightgbm/examples/regression/regression.test");
